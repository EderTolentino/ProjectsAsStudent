        ...
        <main>  
            <div id="janela_transportadoras">
                ...
                <ul>
                    ...
                    <li><a href="alteracao_transportadoras.php?codigo=<?php echo $linha["transportadoraID"] ?>">Alterar</a> </li>
                    <li><a href="exclusao_transportadoras.php?codigo=<?php echo $linha["transportadoraID"] ?>">Excluir</a> </li>
                </ul>
                <?php
                    }
                ?>
